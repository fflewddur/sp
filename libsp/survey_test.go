...
func TestWriteR(t *testing.T) {
	...
	var tests = []string{
		...
		`scale_40b8b453a7470c9a6405915c164d5c2aefb11b60 <- c("Group 1", "Group 2", "Group 3", "No response")`,
		...
		"Q10Label_1 = col_logical(),",
		"Q10Label_2 = col_logical(),",
		"Q10Label_3 = col_logical(),",
		"pgr_item.1_GROUP = col_factor(levels = scale_40b8b453a7470c9a6405915c164d5c2aefb11b60),",
		"pgr_item.1_RANK = col_factor(levels = scale_6e0893b06a434e2872d7c7f9430394c9318f3537, ordered = TRUE),",
		"pgr_item.2_GROUP = col_factor(levels = scale_40b8b453a7470c9a6405915c164d5c2aefb11b60),",
		"pgr_item.2_RANK = col_factor(levels = scale_6e0893b06a434e2872d7c7f9430394c9318f3537, ordered = TRUE),",
		"pgr_item.3_GROUP = col_factor(levels = scale_40b8b453a7470c9a6405915c164d5c2aefb11b60),",
		"pgr_item.3_RANK = col_factor(levels = scale_6e0893b06a434e2872d7c7f9430394c9318f3537, ordered = TRUE),",
		"pgr_item.4_GROUP = col_factor(levels = scale_40b8b453a7470c9a6405915c164d5c2aefb11b60),",
		"pgr_item.4_RANK = col_factor(levels = scale_6e0893b06a434e2872d7c7f9430394c9318f3537, ordered = TRUE),",
		"pgr_other_GROUP = col_factor(levels = scale_40b8b453a7470c9a6405915c164d5c2aefb11b60),",
		...
		"rm(scale_40b8b453a7470c9a6405915c164d5c2aefb11b60)",
