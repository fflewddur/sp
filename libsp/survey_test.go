...
func TestWriteCSV(t *testing.T) {
	...
	var tests = [][]string{
		[]string{"id", "finished", "progress", "duration", "QID2_1", "QID2_2", "QID2_3", "QID12", "QID9_1", "QID9_2", "QID9_3", "QID5_1", "QID5_2", "QID5_3", "QID5_4", "QID6_1", "QID6_2", "QID6_3", "QID8_TEXT", "QID4_1", "QID4_2", "QID4_3", "QID4_5", "QID4_5_TEXT", "QID4_6", "QID4_6_TEXT", "QID4_4", "QID15", "QID11", "QID10_1", "QID10_2", "QID10_3", "QID3", "QID1", "QID7_TEXT"},
		[]string{"R_1dtWhiBDD96nfyk", "true", "100", "122", "", "", "", "", "field 1", "field 2", "field 3", "Click to write Scale point 1", "Click to write Scale point 2", "Click to write Scale point 3", "Click to write Scale point 3", "Click to write Scale point 1", "", "Click to write Scale point 2", "multiple\nlines\nof\ntext?", "", "", "Click to write Choice 3", "Other1", "other response 1", "Other2", "other response 2", "", "6", "Click to write Choice 2", "3", "2", "1", "Click to write Choice 2", "Click to write Choice 1", "one line of text"},
