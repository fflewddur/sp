...
func TestWriteR(t *testing.T) {
	...
	r = bufio.NewReader(&b)
	var tests = []string{
		"# Generated by sp " + Version + " (https://github.com/fflewddur/sp) on " + now.Format("2006-01-02"),
		"",
		"library(tidyr)",
		"library(dplyr)",
		"library(readr)",
		...
		"q4label_5_text = col_character(),",
		"q4label_6 = col_logical(),",
		"q4label_6_text = col_character(),",
		...
		"q5label_other_text = col_character(),",
		...
		"q7label_text = col_character(),",
		"q8label_text = col_character(),",
		...
		"q28_other_text = col_character(),",
		"q23_1 = col_double(),",
		"q23_2 = col_double(),",
		"q23_3 = col_double(),",
		"q23_4 = col_double(),",
		"q23_4_text = col_character(),",
		...
		"",
		"# Labels from the survey definition file",
		"labels_Multiple answer w/ coded responses <- list(",
		`"Click to write Choice 1 (ordered 1st)" = "choice1",`,
		`"Click to write Choice 3 (ordered 2nd)" = "choice3",`,
		`"Click to write Choice 2 (ordered 3rd)" = "choice2",`,
		`"None" = "none"`,
		")",
	}
	for row, test := range tests {
